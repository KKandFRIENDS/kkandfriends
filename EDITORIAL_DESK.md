...
- If the leading candidate still fails after one editor-guided rewrite, the editor tries the next two eligible ranked candidates with fresh research, writing and review before declaring final failure.
